...
module.exports = internals.Bait = function (options) {
    ...
    this.getOpenPullRequests = scm.getOpenPullRequests;
    //var scheduler = new Scheduler(settings);
    //this.initializeScheduler = scheduler.initializeScheduler;
    //this.addSchedule = scheduler.addSchedule;
    //this.removeSchedule = scheduler.removeSchedule;
