...
exports.getPullRequests = function(jobId, cb) {
...
//       if (jobConfig.scm.type === 'git') {
           var bobber = new Bobber({});
           var workspace = internals.SCM.settings.dirPath + '/' + jobId + '/' + internals.SCM.settings.workspace;
           bobber.getPullRequests(jobConfig.scm, function (prs) {
...
exports.getPullRequest = function(jobId, number, cb) {
...
//       if (jobConfig.scm.type === 'git') {
           var bobber = new Bobber({});
           var workspace = internals.SCM.settings.dirPath + '/' + jobId + '/' + internals.SCM.settings.workspace;
           bobber.getPullRequest(jobConfig.scm, number, function (pr) {
