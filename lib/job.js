...
module.exports = internals.Job = function (settings) {
    ...
    //internals.Job.addSchedule = scheduler.addSchedule;
    //internals.Job.removeSchedule = scheduler.removeSchedule;
};
...
/*
   if (config.schedule) {
       if (config.schedule.type === 'cron') {
           internals.Job.addSchedule(pail.id);
       }
   }
*/
...
/*
   if (config.schedule && config.schedule.type === 'cron') {
       internals.Job.removeSchedule(jobId);
   }
*/
   return null;
};
...
/*
   if (config.schedule) {
       if (config.schedule.type === 'cron') {
           internals.Job.removeSchedule(jobId);
           internals.Job.addSchedule(jobId);
       } else {
           internals.Job.removeSchedule(jobId);
       }
   }
