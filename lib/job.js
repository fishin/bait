...
/*
   ...
   if (job.scm && job.scm.runOnCommit) {
       console.log('checking if commit was updated');
       return null;
       // get remote commit
       //var lastCommit = internals.Job.getLatestCommit(jobId);
       // get last commit
       //var remoteCommit = internals.Job.getLatestRemoteCommit(job.scm.url);
       //console.log('lastCommit: ' + lastCommit);
       //console.log('remoteCommit: ' + remoteCommit);
